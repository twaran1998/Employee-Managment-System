...
var _EmployeeSearch = _interopRequireDefault(require("./EmployeeSearch"));
...
var _graphQLFetch = require("../../graphQLFetch");
...
var EmployeeDirectory = /*#__PURE__*/function (_React$Component) {
  ...
  function EmployeeDirectory() {
    ...
    _defineProperty(_assertThisInitialized(_this), "EmployeeData", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var url,
          query,
          response,
          _args = arguments;
  ...
  _createClass(EmployeeDirectory, [{
    ...
    value: function loadData() {
      ...
      var query = "query {\n        employeeList {\n            id\n            FirstName\n            LastName\n            Age\n            DateOfJoining\n            Title\n            Department\n            EmployeeType\n            CurrentStatus\n        }\n      }";
      this.EmployeeData('/graphql', query).then(function (result) {
        _this2.setState({
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement(_EmployeeSearch["default"], null), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement(_EmployeeTable["default"], {
...
var _default = EmployeeDirectory;
